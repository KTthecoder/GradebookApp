                ...
                <div className='HomeSection3'>
                    ...
                    <div className='HomeSection3Main'>
                        <div className='HomeSection3MainDiv'>
                            <div className='HomeSection3MainDivImgDiv'>
                                <img src={GradesSVG} className='HomeSection3MainDivImg' alt='Grades SVG'/>
                    ...
                    <div className='HomeSection3Main'>
                        ...
                        <div className='HomeSection3MainDivTextDiv'>
                            ...
                            <div className='HomeSection3MainDivImgDiv'>
                                <img src={AttendanceSVG} className='HomeSection3MainDivImg' alt='Attendance SVG'/>
                                <div className='HomeSection3MainDivImgBack'></div>
                            </div>
                        </div>
                    </div>
                    <div className='HomeSection3Main'>
                        <div className='HomeSection3MainDiv'>
                            <div className='HomeSection3MainDivImgDiv'>
                                <img src={TasksSVG} className='HomeSection3MainDivImg' alt='Tasks SVG'/>
                                <div className='HomeSection3MainDivImgBack'></div>
                            </div>
                            <div className='HomeSection3MainDivTextDiv'>
